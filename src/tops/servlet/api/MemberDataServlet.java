 ...
 */
@WebServlet("/API/MemberData")
public class MemberDataServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static Logger logger = Logger.getLogger(MemberDataServlet.class);
		...
		*/
		...
		try{
	        ...
	        if(!results.next()) {
	    		...
	    		conn.close();
	    		conn = null;
	    		out.println(new MemberDataResponse(false, null).toJson()); 
	    		return;
	        }
        	...
        	out.println(new MemberDataResponse(true, member).toJson());
